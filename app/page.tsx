  ...
  return (
    <Shell>
      <main>
          ...
          <div className="w-full overflow-hidden rounded-[36px] border border-[#e9e1d7] bg-[#f4efe8] shadow-[0_30px_80px_rgba(34,26,18,0.06)]">
            <div className="grid items-center gap-6 px-5 py-5 md:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-10 lg:py-6">
              <div className="max-w-xl">
                ...
                <h1 className="font-editorial text-3xl leading-[0.95] text-[#1b261d] sm:text-5xl lg:text-[4rem]">
                  Flores para dizer
        ...
        <section id="ocasiões" className="bg-[#173d28] py-10 sm:px-6 lg:px-8">
        ...
        <section className="bg-[#173d28] py-16">
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:px-8">
            <div className="rounded-[32px] border border-white/10 bg-[#173d28]/90 p-5 text-white shadow-[0_30px_80px_rgba(45,39,30,0.04)] sm:p-8">
              <p className="text-[11px] uppercase tracking-[0.3em] text-[#dfead8]">Entrega</p>
              <h2 className="mt-4 font-serif text-4xl leading-none text-white sm:text-5xl">A experiência continua até a entrega.</h2>
              <div className="mt-8 space-y-5 text-[#eaf3ea]">
                <div className="flex gap-4 rounded-[20px] border border-white/10 bg-white/6 p-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#edf3ea] text-xl text-[#21402c]">01</div>
                  <div>
                    <p className="font-semibold text-white">Personalize o presente</p>
                    <p className="mt-1 text-sm leading-6 text-[#dfead8]">Adicione flores, detalhes e uma mensagem especial.</p>
                  </div>
                </div>
                <div className="flex gap-4 rounded-[20px] border border-white/10 bg-white/6 p-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#edf3ea] text-xl text-[#21402c]">02</div>
                  <div>
                    <p className="font-semibold text-white">Escolha a entrega</p>
                    <p className="mt-1 text-sm leading-6 text-[#dfead8]">Defina o destino, a data e os detalhes do endereço.</p>
                  </div>
                </div>
                <div className="flex gap-4 rounded-[20px] border border-white/10 bg-white/6 p-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#edf3ea] text-xl text-[#21402c]">03</div>
                  <div>
                    <p className="font-semibold text-white">Finalize com confiança</p>
                    <p className="mt-1 text-sm leading-6 text-[#dfead8]">Checkout simples e comunicação clara em cada etapa.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-[36px] border border-[#e8dbcf] bg-[#fefdfb] p-6 shadow-[0_30px_80px_rgba(38,31,24,0.04)] lg:p-10">
              <div className="grid gap-8 lg:grid-cols-[1fr_1.1fr] lg:items-center">
                <div>
                  ...
                  <h2 className="mt-4 font-serif text-4xl leading-none text-[#1b251d] sm:text-6xl">
        ...
        <section className="bg-[#f3efe9] py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="overflow-hidden rounded-[34px] border border-[#e7dacd] bg-[#f9f6f2] p-6 shadow-[0_30px_80px_rgba(22,42,26,0.12)] sm:p-8 lg:p-10">
              <div className="grid gap-8 lg:grid-cols-[1fr_0.95fr] lg:items-center">
                <div>
                  <p className="text-[11px] uppercase tracking-[0.3em] text-[#6a7a68]">Agendamento</p>
                  <h2 className="mt-4 font-serif text-4xl leading-none text-[#1b251d] sm:text-6xl">
                    Seu presente pode ser agendado com a gente.
                  </h2>
                  <p className="mt-4 max-w-xl text-base leading-7 text-[#4d5b4e]">
                  ...
                  <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                    <Link
                      href="/agendamento"
                      className="inline-flex items-center justify-center rounded-full bg-[#1d3d28] px-5 py-3.5 text-sm font-medium text-white transition hover:bg-[#163122]"
                    >
                      Agendar pelo site
                    </Link>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center justify-center rounded-full border border-[#d6cdc0] bg-white px-5 py-3.5 text-sm font-medium text-[#173a25] transition hover:border-[#9db09a]"
                    >
                ...
                <div className="rounded-[28px] border border-[#e7dacd] bg-[#fffdfb] p-5 shadow-[0_20px_40px_rgba(38,31,24,0.05)]">
                  <p className="text-[11px] uppercase tracking-[0.28em] text-[#6a7a68]">Contatos</p>
                  <ul className="mt-5 space-y-3 text-sm text-[#1f3328]">
                    {brand.phones.map((phone) => (
                      <li key={phone} className="rounded-full border border-[#e7dacd] bg-[#f6f1ea] px-4 py-3">
                        <a href={`tel:${phone.replace(/[^\d+]/g, "")}`} className="hover:text-[#163122]">
                          {phone}
                        </a>
                      </li>
                    ))}
                  </ul>
                  <div className="mt-5 rounded-[20px] border border-[#e7dacd] bg-[#f3f7f0] p-4 text-[#173a25]">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-4 flex justify-end sm:hidden">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-block text-sm font-medium text-[#eef5ee] underline decoration-white/60 underline-offset-4"
              >
                Conhecer nosso Instagram
              </a>
            </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:gap-4">
              {instagramPosts.map((src, index) => (
                <InstagramTile
                  key={src + index}
                  src={src}
                  alt={`${brand.instagram} image ${index + 1}`}
                  tall={index % 2 === 1}
                />
              ))}
            </div>
        ...
        <section className="border-t border-[#e7ddd0] bg-[#f3efe9]">
          <div className="mx-auto flex max-w-7xl flex-col gap-5 px-4 py-12 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div>
              ...
              <h2 className="mt-2 font-serif text-4xl text-[#1d2a1e] sm:text-5xl">Flores para todas as ocasiões.</h2>
            </div>
