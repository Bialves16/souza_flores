        ...
        <section className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="rounded-[30px] border border-[#ebdfd6] bg-[#fffdfb] p-6 shadow-[0_20px_60px_rgba(30,32,28,0.05)] sm:p-8">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <button className="inline-flex flex-1 items-center justify-center rounded-full bg-[#1d3d28] px-5 py-3.5 text-sm font-medium text-white transition hover:bg-[#163122]">
                Adicionar ao meu presente
              </button>
